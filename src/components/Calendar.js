...
const Calendar = () => {
  ...
  const checkTime = (data) => {
    ...
    const compareStartTime = moment(streamStartDate + ' ' + streamStartTime, "DD.MM.YYYY HH:mm").diff(now, "minutes");
    const compareEndTime = moment(streamStartDate + ' ' + streamEndTime, "DD.MM.YYYY HH:mm").diff(now, "minutes");
    console.log('diff ' + streamStartDate + ' ' + streamStartTime + ' ' + compareStartTime);
    console.log('diff end ' + streamStartDate + ' ' + streamEndTime + ' ' + compareEndTime);
